...
<body>
    ...
    <aside class="sidebar lms-sidebar">
        ...
        <a href="class.php?class_id=<?= $class_id ?>" class="active">
            <span class="nav-ico" aria-hidden="true">▤</span><?= htmlspecialchars($currentClass['class_name']) ?>
        </a>
                                    ...
                                    <tbody>
                                        <?php foreach ($gradeRows as $row): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        <button type="submit" name="save_grade" class="btn btn-primary btn-sm">
                                                            Save
                                                        </button>
                                                    </form>
                                                </td>
                        ...
                        <?php if ($mySubmission && $mySubmission['grade'] !== null): ?>
                            ...
                            <?php if (!empty($mySubmission['submitted_at'])): ?>
                                <p class="text-muted mb-0">
                                    Submitted at <?= htmlspecialchars($mySubmission['submitted_at']) ?>
                                </p>
                            <?php else: ?>
                                <p class="text-muted mb-0">
